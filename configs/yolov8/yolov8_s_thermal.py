...
# -----data related-----
data_root = 'data/potholes/'  # Root path of data
# Path of train annotation file
train_ann_file = 'train_annotations1.json'
train_data_prefix = 'dataset/dataset/train/images'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'valid_annotations1.json'
val_data_prefix = 'dataset/dataset/valid/images'  # Prefix of val image path
...
metainfo = dict(classes=class_name, palette=[(20, 220, 60), (0, 0, 255), 255, 0, 0])
